...
**最終更新**: 2026-09-05 / セッションB。**036、Rの指摘2件を対応しPR #243を
更新した。**Rの再レビュー待ち。
...
390/768/1280/1920の4幅で再実測し、`cover`で問題だった1280・1920も含めて
全幅でフェード帯の最大差（1.5〜2.0）が対照区間の基底ノイズ（0.75〜1.0）と
同水準であることを確認した（`artifacts/036/seam.md`・
`seam-measurement-widths.json`）。
