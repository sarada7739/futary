...
**最終更新**: 2026-09-06 / セッションB。**037（AIまとめ）完了・mainへマージ済み**
（PR #250、squashコミット`070b80d`）。**T9の走査自体の穴（037が作ったもの
ではない）は038として切り出された**（A・Rの判断。PR #257）。
`task/038-viewer-key-scan`へ着手する。
