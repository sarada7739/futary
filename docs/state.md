...
1〜3節（記念日カード・デモバナー・機能パネル）を実装し、指示どおり
ここで再度停止。`task/035-rich-ui`ブランチで作業。残り12画面・サインイン
個別作り込み・4節以降（ボケ画像等）には進んでいない。**
...
**次にやること**: **ここでいったん停止**（Aの指示「1→2→3まで進んだ時点で、
もう一度画像を撮って止まる」）。人間・Aの確認を待つ。
