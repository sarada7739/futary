...
| 11 | リリース履歴 | **入れる**（段階1: 2.2.0「アルバムの写真をまとめて持ち出せます」、段階2: **2.4.0**「プレミアムプランを始めました」。2.3.0 は 050 が使った）。文言は 4節 | 利用者に見える |
...
| 2.4.0（段階2） | プレミアムプランを始めました | 写真を 5 万枚まで保存できます / 月額と年額から選べます | `/premium` |
