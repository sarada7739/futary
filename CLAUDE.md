...
| セッション | 作業ディレクトリ | 担当 | 絶対にやらないこと |
|---|---|---|---|
| **A** 設計 | `futary-A/` | 要件・設計・タスク作成・仕様変更判断 | 実装差分を読まない |
| **R** レビュー | `futary-R/` | 実装レビュー・受け入れ判定 | 設計変更しない。書き込まない |
| **B** 実装 | `futary/` | コード・テスト・動作証跡 | 自分の実装を自己採点しない |
