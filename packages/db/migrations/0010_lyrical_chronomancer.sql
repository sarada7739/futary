...
INSERT INTO `__new_events`("id", "couple_id", "date", "title", "kind", "repeat_yearly", "time", "created_by", "is_shared", "created_at") SELECT "id", "couple_id", "date", "title", "kind", "repeat_yearly", "time", "created_by", "is_shared", "created_at" FROM `events`;--> statement-breakpoint
